  ...
  return (
    <figure className={styles.media}>
      <div className={styles.mediaMat}>
        <AdmovMark outline className={styles.frameMark} />
  ...
  return (
    <div className={styles.walkthrough}>
      ...
      <div className={styles.stage} id="i8chat-walkthrough-stage" role="region" aria-label={`${copy.walkthrough}: ${copy.steps[step]}`}>
        <AdmovMark outline className={styles.stageWatermark} />
        <div className={styles.scene} key={step}>
          {step === 0 && <>
            <div className={styles.postCard}><div className={styles.sampleHeader}><span className={styles.sampleAvatar}><AdmovMark className={styles.brandMark} /></span><span>{copy.post}</span><MessageCircle size={17} aria-hidden /></div><p>{copy.postText}</p><span className={styles.postRule} aria-hidden /></div>
