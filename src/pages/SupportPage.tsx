    ...
    <PageChrome>
      ...
      <div className="prose prose-invert max-w-none space-y-12 text-zinc-300 leading-relaxed">
        ...
        <section>
          ...
          <ul className="list-disc list-inside mt-3 space-y-2 text-zinc-400">
            <li><Link to="/terms" className="text-violet hover:text-violet-light transition-colors">{c.termsLabel}</Link></li>
            <li><Link to="/privacy" className="text-violet hover:text-violet-light transition-colors">{c.privacyLabel}</Link></li>
          </ul>
        </section>
